...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="daohang">
    <tr>
        <td width="15"></td>
        <td width="100">
            <a href="index.htm" class="hover"><img src="img/4.jpg" width="100" height="47" border="0"/></a>
        </td>
        <td width="885">
                        ...
                        <div id="menu" style="width:885px; margin:0; z-index:1">
                            ...
                            <ul id="treemenu1">
                               ...
                               <li style="z-index:1; z-index:999">
                                ...
                                <%--</li>--%>
                                <%--<li style="z-index:1; z-index:999">--%>
                                    <%--<a href="jnjd.htm">技能鉴定</a>--%>
                                    <%--<ul>--%>
                                        <%--<li style="z-index:999">--%>
                                            <%--<a href="jnjd/xytyzygzjd.htm">行业特有职业工种鉴定</a>--%>
                                        <%--</li>--%>
                                        <%--<li style="z-index:999">--%>
                                            <%--<a href="jnjd/qgsjzygzjd.htm">全国省级职业工种鉴定</a>--%>
                                        <%--</li>--%>
                                    <%--</ul>--%>
                                <%--</li>--%>
                                <%--<li style="z-index:1; z-index:999">--%>
                                    <%--<a href="exljzxks.htm">二学历及自学考试</a>--%>
                                    <%--<ul>--%>
                                        <%--<li style="z-index:999">--%>
                                            <%--<a href="exljzxks/exl.htm">二学历</a>--%>
                                        <%--</li>--%>
                                        <%--<li style="z-index:999">--%>
                                            <%--<a href="exljzxks/zxks.htm">自学考试</a>--%>
                                        <%--</li>--%>
                                    <%--</ul>--%>
                                <%--</li>--%>
                                <%--<li style="z-index:1; z-index:999">--%>
                                    <%--<a href="gjjsjdjks.htm">国家计算机等级考试</a>--%>
                                    <%--<ul>--%>
                                        <%--<li style="z-index:999">--%>
                                            <%--<a href="gjjsjdjks/gjjsjdjksksgg.htm">国家计算机等级考试考试公告</a>--%>
                                        <%--</li>--%>
                                        <%--<li style="z-index:999">--%>
                                            <%--<a href="gjjsjdjks/gjjsjdjkscjcx.htm">国家计算机等级考试成绩查询</a>--%>
                                        <%--</li>--%>
                                    <%--</ul>--%>
                                <%--</li>--%>
                                <!--#endeditable-->
        ...
        <td width="500" style="border:1px solid #82b8df">
            ...
            <script language="JavaScript">
                ...
                function u_u1_init_img() {
                    ...
                    u_u1_icn.addimg("img/B8DE7080C6751D20604A1A8830D_A0EAE45E_80F6.jpg", "/1231.htm",
                    "", ""
                )
                    ;

                    u_u1_icn.addimg("F61A6E86C08B247FF1445FA4903_C8FE903A_16E8E6.jpg", "1221.htm", "", "");

                    u_u1_icn.addimg("FD99E02A2864DC5766204C960B8_6280BCB2_3B4A8C.jpg", "info\/1006\/1208.htm", "", "");

                    u_u1_icn.addimg("4E4FF082B40AF5B7E9976126B29_78EE42EE_14B3D.jpg", "info\/1006\/1191.htm", "", "");

                    u_u1_icn.addimg("FC153F4E6C96F781ABE06388612_AD8E9CC7_6967.jpg", "info\/1006\/1012.htm", "", "");

                    u_u1_icn.addimg("B8DE7080C6751D20604A1A8830D_A0EAE45E_80F6.jpg", "info\/1006\/1010.htm", "", "");
            ...
            <table cellspacing="0" cellpadding="0" border="0" style="padding:0px margin:0px; border:0px">
                <tr>
                    <td>
                        <div style="OVERFLOW: hidden;height:385px;width:500px">
                            <div id="u_u1_div" align="center"
                                 style="padding:0px;margin:0px;border:0px solid black;background-color:#000000;FILTER: progid:DXImageTransform.Microsoft.RevealTrans (duration=2.0,transition=23);height:385px;width:500px">
                                <div id="u_u1_imgdiv" style="padding:0px;border:0px;">
                                    <a id="u_u1_url" target="_blank"><img id="u_u1_pic" border="0" width="500"
                                                                          height="385" src="img/space.gif"></a>
                                </div>
                            </div>
                            <div style="filter:alpha(style=1,opacity=10,finishOpacity=80);width:500px;height:19px;text-align:right;top:-19px;position:relative;padding:0px;margin:0px;border:0px;">
                                <a href="javascript:u_u1_icn.changeimg(0)" ; id="u_u1_selectNode0"
                                   class="imagechangenews_pnode" target="_self">1</a>
                                <a href="javascript:u_u1_icn.changeimg(1)" ; id="u_u1_selectNode1"
                                   class="imagechangenews_pnode" target="_self">2</a>
                                <a href="javascript:u_u1_icn.changeimg(2)" ; id="u_u1_selectNode2"
                                   class="imagechangenews_pnode" target="_self">3</a>
                                <a href="javascript:u_u1_icn.changeimg(3)" ; id="u_u1_selectNode3"
                                   class="imagechangenews_pnode" target="_self">4</a>
                                <a href="javascript:u_u1_icn.changeimg(4)" ; id="u_u1_selectNode4"
                                   class="imagechangenews_pnode" target="_self">5</a>
                                <a href="javascript:u_u1_icn.changeimg(5)" ; id="u_u1_selectNode5"
                ...
                <div align="center" display="none"
                     style="overflow:hidden;text-overflow:ellipsis;height:0px;width:500px;">
                    <a target="_blank" class="titlestyle202496" id="u_u1_newstitle"></a>
                </div>
                <div align="left" display="none"
                     style="overflow:hidden;text-overflow:ellipsis;height:0px;width:500px;padding-left:2px;padding-right:2px">
                        ...
                        <div id="block2">
                            ...
                            <UL id="rolltxt">
                                <TABLE width="400" align="center" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <TR>
                                        <TD height="18">
                                            <FONT color="#0052b6">公告通知 -</FONT>&nbsp;
                                            <A title="信息标题：2019年5月27日--30日办理2019年上半年自学考试本科毕业证书"
                                               href="info/1007/1232.htm" target="_blank">
                                                <FONT style="FONT-SIZE: 12px">2019年5月27日--30日...</FONT>
                                            </A>&nbsp;
                                            <FONT class="counttext"></FONT>
                                        </TD>
                                        <TD width="100" align="right" style="COLOR: #999">2019-05-22</TD>
                                    </TR>

                                    <TR>
                                        <TD height="18">
                                            <FONT color="#0052b6">新闻中心 -</FONT>&nbsp;
                                            <A title="信息标题：我校启动2019年度吉林省营养配餐员培训工作" href="info/1006/1231.htm"
                                               target="_blank">
                                                <FONT style="FONT-SIZE: 12px">我校启动2019年度吉...</FONT>
                                            </A>&nbsp;
                                            <FONT class="counttext"></FONT>
                                        </TD>
                                        <TD width="100" align="right" style="COLOR: #999">2019-05-21</TD>
                                    </TR>

                                    <TR>
                                        <TD height="18">
                                            <FONT color="#0052b6">新闻中心 -</FONT>&nbsp;
                                            <A title="信息标题：2019年国家计算机等级考试成绩" href="info/1006/1225.htm" target="_blank">
                                                <FONT style="FONT-SIZE: 12px">2019年国家计算机等...</FONT>
                                            </A>&nbsp;
                                            <FONT class="counttext"></FONT>
                                        </TD>
                                        <TD width="100" align="right" style="COLOR: #999">2019-05-15</TD>
                                    </TR>

                                    <TR>
                                        <TD height="18">
                                            <FONT color="#0052b6">公告通知 -</FONT>&nbsp;
                                            <A title="信息标题：关于中式烹调师、中式面点师技能鉴定补考报名通知" href="info/1007/1223.htm"
                                               target="_blank">
                                                <FONT style="FONT-SIZE: 12px">关于中式烹调师、中...</FONT>
                                            </A>&nbsp;
                                            <FONT class="counttext"></FONT>
                                        </TD>
                                        <TD width="100" align="right" style="COLOR: #999">2019-05-06</TD>
                                    </TR>

                                    <TR>
                                        <TD height="18">
                                            <FONT color="#0052b6">新闻中心 -</FONT>&nbsp;
                                            <A title="信息标题：2019年第1期焊工职业技能鉴定工作" href="info/1006/1221.htm"
                                               target="_blank">
                                                <FONT style="FONT-SIZE: 12px">2019年第1期焊工职业...</FONT>
                                            </A>&nbsp;
                                            <FONT class="counttext"></FONT>
                                        </TD>
                                        <TD width="100" align="right" style="COLOR: #999">2019-04-29</TD>
                                    </TR>
                                </TABLE>
                            </UL>
                            <script>
                        ...
                        <table width="468" border="0" cellpadding="0" cellspacing="0" align="center">
                            ...
                            <tr>
                                <td height="26">&nbsp;&nbsp;<img src="img/10.jpg"/>
                                    <a href="info/1006/1231.htm" title="我校启动2019年度吉林省营养配餐员培训工作" target="_blank">
                                        <font style="font-size:12px;">我校启动2019年度吉林省营养配餐员培训工作</font>
                                    </a>
                                </td>
                                <td width="102" align="right">
                                    <font style="font-size:12px; padding-right:5px;">[ 2019-05-21 ]
                                    </font>
                                </td>
                            </tr>
                            <tr>
                                <td height="26">&nbsp;&nbsp;<img src="img/10.jpg"/>
                                    <a href="info/1006/1225.htm" title="2019年国家计算机等级考试成绩" target="_blank">
                            ...
                            <tr>
                                <td height="26">&nbsp;&nbsp;<img src="img/10.jpg"/>
                                    <a href="info/1006/1221.htm" title="2019年第1期焊工职业技能鉴定工作" target="_blank">
                            ...
                            <tr>
                                <td height="26">&nbsp;&nbsp;<img src="img/10.jpg"/>
                                    <a href="info/1006/1208.htm" title="传播现代农业技术 服务地方经济发展" target="_blank">
                            ...
                            <tr>
                                <td height="26">&nbsp;&nbsp;<img src="img/10.jpg"/>
                                    <a href="info/1006/1200.htm" title="2019年上半年自学考试工作顺利完成" target="_blank">
                ...
                <tr>
                    <td height="135" valign="top" class="xinwen1">
                        <table width="468" border="0" cellpadding="0" cellspacing="0" align="center">
                            ...
                            <tr>
                                <td height="26">&nbsp;&nbsp;<img src="img/10.jpg"/>
                                    <a href="info/1007/1232.htm" title="2019年5月27日--30日办理2019年上半年自学考试本科毕业证书"
                                       target="_blank">
                            ...
                            <tr>
                                <td height="26">&nbsp;&nbsp;<img src="img/10.jpg"/>
                                    <a href="info/1007/1223.htm" title="关于中式烹调师、中式面点师技能鉴定补考报名通知" target="_blank">
                            ...
                            <tr>
                                <td height="26">&nbsp;&nbsp;<img src="img/10.jpg"/>
                                    <a href="info/1007/1211.htm" title="吉林省教育基金2019年度优秀特困生扶助奖学金评选公告" target="_blank">
                            ...
                            <tr>
                                <td height="26">&nbsp;&nbsp;<img src="img/10.jpg"/>
                                    <a href="info/1007/1204.htm" title="2019年上半年农业行业特有工种职业技能鉴定公告" target="_blank">
                            ...
                            <tr>
                                <td height="26">&nbsp;&nbsp;<img src="img/10.jpg"/>
                                    <a href="info/1007/1201.htm" title="2019年上半年自学考试考前须知" target="_blank">
                        ...
                        <td id="demo1">
                            <table height="50" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="snjj.htm" target="_blank"><img src="img/201338133230101.jpg" alt=""
                                                                                width="220" height="50" hspace="4"
                                                                                border="0"/></a>
                                    </td>
                                    <td>
                                        <a href="crhs.htm" target="_blank"><img src="img/201338133245926.jpg" alt=""
                                                                                width="220" height="50" hspace="4"
                                                                                border="0"/></a>
                                    </td>
                                    <td>
                                        <a href="#" target="_blank"><img src="img/201338133258674.jpg" alt=""
                                                                         width="220" height="50" hspace="4" border="0"/></a>
                                    </td>
                                    <td>
                                        <a href="#" target="_blank"><img src="img/201338133312825.jpg" alt=""
                                                                         width="220" height="50" hspace="4" border="0"/></a>
                                    </td>
                                    <td>
                                        <a href="#" target="_blank"><img src="img/201338133326740.jpg" alt=""
                                                                         width="220" height="50" hspace="4" border="0"/></a>
                                    </td>
                                    <td>
                                        <a href="gzzd.htm" target="_blank"><img src="img/201338133342459.jpg" alt=""
                                                                                width="220" height="50" hspace="4"
                                                                                border="0"/></a>
                                    </td>
                                    <td>
                                        <a href="#" target="_blank"><img src="img/201338133352675.jpg" alt=""
                                                                         width="220" height="50" hspace="4" border="0"/></a>
                                    </td>
                                    <!--#endeditable-->
                                    </td>
